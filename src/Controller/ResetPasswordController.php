...
class ResetPasswordController extends AbstractController
{
    ...
    public function __construct(
        ...
        private FlashBagInterface $flashBag // Ajouter FlashBagInterface à votre constructeur
    ) {
    }
    ...
    public function reset(Request $request, UserPasswordHasherInterface $passwordHasher, TranslatorInterface $translator, string $token = null): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->flashBag->add('success', 'Your password has been successfully restored.');
    ...
    private function processSendingPasswordResetEmail(UserRepository $userrepo,string $emailFormData, MailerInterface $mailer, TranslatorInterface $translator): RedirectResponse
    {
        ...
        $email = (new TemplatedEmail())
            ->from(new Address('Hajer.Mabrouk@esprit.tn', 'WasteWise Bot'))
            ->to($user->getEmail())
