...
class TruckController extends AbstractController
{
    ...
    public function index(TruckRepository $truckRepository,PaginatorInterface $paginator,Request $request, NotificationRepository  $notificationRepository): Response
    {
    ...
    public function new(Request $request, EntityManagerInterface $entityManager, NotificationRepository  $notificationRepository): Response
    {
        $truck = new Truck();
    ...
    public function show(Truck $truck, NotificationRepository  $notificationRepository): Response
    {
        $notifications = $notificationRepository->findAll();
    ...
    public function edit(Request $request, Truck $truck, EntityManagerInterface $entityManager, NotificationRepository  $notificationRepository): Response
    {
        $form = $this->createForm(TruckType::class, $truck);
        $form->handleRequest($request);
        $notifications = $notificationRepository->findAll();
    ...
    public function delete(Request $request, Truck $truck, EntityManagerInterface $entityManager, NotificationRepository  $notificationRepository): Response
    {
        $notifications = $notificationRepository->findAll();
