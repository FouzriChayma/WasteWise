 ...
 */
final class Version20240215210231 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE planification (id_plan INT AUTO_INCREMENT NOT NULL, id_mission INT DEFAULT NULL, id_driver INT NOT NULL, date DATETIME NOT NULL, location VARCHAR(255) NOT NULL, INDEX IDX_FFC02E1B4EFA5B4C (id_mission), PRIMARY KEY(id_plan)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
